 ...
 */
class Pas_View_Helper_FacetCreatorAjaxImages extends Zend_View_Helper_Abstract {
    ...
    public function facetCreatorAjaxImages(array $facets){
        if(is_array($facets)){
        $html = '';
