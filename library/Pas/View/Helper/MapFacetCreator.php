...
class Pas_View_Helper_MapFacetCreator extends Zend_View_Helper_Abstract
{
    ...
    public function mapFacetCreator()
    {
        ...
        if (is_array($facets)) {
            $html = '<p>Total results available: ' . number_format($total)
                . '<br />These results might differ to the expected results. We only allow you to see records available to you</p>';
