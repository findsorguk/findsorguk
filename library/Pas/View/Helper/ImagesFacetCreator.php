 ...
 */
class Pas_View_Helper_ImagesFacetCreator extends Zend_View_Helper_Abstract {
    ...
    public function imagesFacetCreator(array $facets){
        if(is_array($facets)){
    ...
    protected function _processFacet(array $facet, $facetName){
		...
		//Check for removal html to be displayed.
