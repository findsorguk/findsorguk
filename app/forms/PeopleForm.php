 ...
 * @todo Create a database table for titles?
 */
    ...
    public function __construct(array $options = null) {
        ...
        $title->setLabel('Title: ')
                ...
                ->addMultiOptions(array(
                    ...
                    'Countess' => 'Countess', 
                    'Earl' => 'Earl',
                    'Field Marshal Lord' => 'Field Marshal Lord', 
                    'General' => 'General',
                    'Group Captain' => 'Group Captain', 
                    'Lieutenant' => 'Lieutenant', 
                    'Lieutenant Commander' => 'Lieutenant Commander',
                    'Lt-Col' => 'Lt-Col', 
                    'Lt-Gen Sir' => 'Lt-Gen Sir', 
                    'Maj-Gen' => 'Maj-Gen',
                    'Major' => 'Major', 
                    'Prince' => 'Prince', 
                    'Princesss' => 'Princess',
                    ...
                    'The Countess of' => 'The Countess of', 
                    'The Duchess of' => 'The Duchess of',
                    'The Duke of' => 'The Duke of', 
                    'The Earl of' => 'The Earl of',
                    'The Hon' => 'The Hon', 
                    'His Honour Judge' => 'His Honour Judge', 
                    'The Hon Mrs' => 'The Hon Mrs',
                    'The Marchioness of' => 'The Marchioness of', 
                    'The Marquess of' => 'The Marquess of',
                    'The Viscount' => 'The Viscount', 
                    'The Viscountess' => 'The Viscountess',
        ...
        $organisationID->SetLabel('Organisation attached to: ')
                ...
                ->setAttrib('class', 'input-xxlarge selectpicker show-menu-arrow')
                ->addMultiOptions(array(
                    null => 'Please choose an organisation',
                    'Valid organisations' => $organisations_options))
                ->addValidator('InArray', false, 
                        array(array_keys($organisations_options)));
        ...
        $primary_activity->SetLabel('Person\'s primary activity: ')
                ...
                ->addMultiOptions(array(
                    null => 'Choose a primary activity',
