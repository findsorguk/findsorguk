<?php
/**
 * A model for accessing archaeological landscape and topography information from database
 *
 * An example of use:
 *
 * <code>
 * <?php
 * $landscape = new ArchaeologicalLandscape();
 * $landscape_options = $landscape->getOptions();
 * ?>
 * </code>
 *
...
class ArchaeologicalLandscape extends Pas_Db_Table_Abstract {

    /** The table name
     * @access protected
     * @var string
     */
    protected $_name = 'landscapetopography';
    /** The primary key
     * @access protected
     * @var integer
     */
